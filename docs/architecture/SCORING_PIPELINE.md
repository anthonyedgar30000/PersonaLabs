...
2. **Anchor and lens resolution**
   ...
   - The selected lens contributes preferred terms and a presentation policy.
...
3. **Wording-group detection**
   ...
   - Lower-intensity format cues are detected from interview, public radio, long-form, or explanatory source-format wording.
...
5. Strong calm, low-friction, continuity, explanatory, or lower-friction format evidence can produce GREEN.
...
## Generated search and demo lenses

Search and demo lenses are generated by `buildExplorationPaths(...)`:
...
Generated searches preserve subject continuity or load curated demo framing
styles. They do not change candidate classification directly; they influence
scoring through lens preferred terms and presentation policy.

## Retrieval lens presentation

Retrieval uses score-first/lens-constrained presentation:

1. Retrieve structured metadata.
2. Score every candidate through deterministic scoring.
3. Apply the selected lens policy.
4. Render lens-matched suggestions.

Lens presentation must use deterministic labels and score components.
...
### Civic/news escalation pattern

Input: `OUTRAGE: senator meltdown after policy vote`
...
Input: `Senator discusses policy vote on public radio`
