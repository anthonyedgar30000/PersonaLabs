...
cases.forEach((testCase) => {
  ...
  const summary = `${testCase.name}: ${testCase.mode} score=${result.score} classification=${result.classification} tone=${result.dimensions.emotionalTone} subject=${result.dimensions.subjectMatterImpact} load=${result.dimensions.cognitiveLoad} calm=${result.dimensions.calmAmbient}`;
